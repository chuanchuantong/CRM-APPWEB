	...
	<view class="login">
		...
		<view class="content"> 
			...
			<view class="main">
				...
				<wInput name="pwd" type="password" maxlength="11" placeholder="确认密码" @input="getpwd"></wInput>
				<wInput name="pwd" type="text" maxlength="11" placeholder="邮箱" @input="getpwd"></wInput>
				<wInput name="pwd" type="text" maxlength="6" isScan="true"  placeholder="邀请码" @scan="getpwd"></wInput>
				<wInput name="name" type="radio" maxlength="11" placeholder="用户名" @input="getname"></wInput>
			</view>
		...
		methods: {
			...
			startLogin() {
				...
				if (checkRes) {
					...
					if(_this.formData.name!="test"||_this.formData.pwd!="123456"){
						uni.showToast({
							title: "账号密码输入有误",
							icon: "none"
						});
